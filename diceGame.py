...
class TestUM(unittest.TestCase):
    ...
    def testFindBestDice(self):
        self.assertEqual(findBestDice([[1, 1, 6, 6, 8, 8], [2, 2, 4, 4, 9, 9], [3, 3, 5, 5, 7, 7]]), -1)
        self.assertEqual(findBestDice([[1, 1, 2, 4, 5, 7], [1, 2, 2, 3, 4, 7], [1, 2, 3, 4, 5, 6]]), 2)
        self.assertEqual(findBestDice([[3, 3, 3, 3, 3, 3], [6, 6, 2, 2, 2, 2], [4, 4, 4, 4, 0, 0], [5, 5, 5, 1, 1, 1]]), -1)

    def testFindBestStrategy(self):
        self.assertEqual(findBestStrategy([[1, 1, 4, 6, 7, 8], [2, 2, 2, 6, 7, 7], [3, 3, 3, 5, 5, 8]]), {'choose_first': False, 0: 1, 1: 2, 2: 0})
        self.assertEqual(findBestStrategy([[4, 4, 4, 4, 0, 0], [7, 7, 3, 3, 3, 3], [6, 6, 2, 2, 2, 2], [5, 5, 5, 1, 1, 1]]), {'choose_first': True, 'first_dice': 1})
